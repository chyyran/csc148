...
def test_dispatch_distance():
    ...
    manager.register_dispatch(-3, -4)
    assert manager.get_car_position('car3') == (-3, -4)


def test_dispatch_distance_str():
    manager = SuperDuperManager()
    manager.add_car('car1', 2)
    manager.add_car('car2', 10)
    manager.add_car('car3', 20)
    ...
    manager.register_dispatch(-3, -4)
    assert manager.get_car_position('car2') == (-3, -4)


def test_dispatch_distance_fail():
    manager = SuperDuperManager()
    manager.add_car('car1', 2)

    manager.register_dispatch(1000, 1000)
    assert manager.get_car_position('car1') == (0, 0)
